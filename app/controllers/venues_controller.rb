class VenuesController < ApplicationController
  ...
  def venue_params
    params.require(:venue).permit(:venuename, :address, :postcode, :maplink, :station, :price, :min_capacity, :eventmanager, :contact, :image, :website, :category_country, :city, :note)
  end
end
