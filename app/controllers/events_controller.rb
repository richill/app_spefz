class EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:title, :description, :address, :postcode, :latitude, :longitude, :user_id, :category_topic_id, :image, :date, :time, :city, :quantity, :category_age_id, :category_country_id, :quantity_men, :quantity_women, :category_quantitygender_id, :venuename, :price, :time_end, :tag_list, :maplink, :close, :slug, :event_score_access, :display_match, :upcoming_event, :agerange_info, :agerange, :imgvenue_one, :imgvenue_two, :imgvenue_three, :imgevent_one, :imgevent_two, :imgevent_three, :imgevent_four, :imgevent_five, :imgevent_six, :external_event, :external_eventlink, :soldout, :soldout_men, :soldout_women)
  end
end
