class PreferencesController < ApplicationController
  ...
  def preference_params
    params.require(:preference).permit(:town, :user_id, :name, :slug, :idealage_start, :idealage_end, :category_matchseeking_id, :category_matchrelationship_id, :category_matchstatus_id)
  end
end
